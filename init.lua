...
-- -- disable netrw at the very start of your init.lua to enable nvim-tree instead
...
-- Assistance keymaps
vim.keymap.set('n', 'vv', 'viw', { noremap = true, silent = true, desc = 'Select word' })
vim.keymap.set({ 'n', 'v' }, 'H', '^', { noremap = true, silent = true, desc = 'Go to first letter' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [F]iles in buffer_dir' })
...

  {
    ...
    config = function()
      ...
      -- Toggle below [T]erminal on [.]
      vim.keymap.set('n', '<leader>t.', '<cmd>ToggleTerm dir=%:p:h<CR>', { desc = 'Toggle below [T]erminal on [.]' })
      -- Toggle float [T]erminal on . and run [L]azygit (ref. https://github.com/akinsho/toggleterm.nvim/blob/main/README.md#Custom-terminal-usage)
